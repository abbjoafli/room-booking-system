...
import LookingForm from "./components/LookingForm";
...
class App extends Component {
  ...
  onSignUp = ({ firstName, lastName, email, password, klass }) => {
    ...
    signUp({ firstName, lastName, email, password, klass }).then(
      decodedToken => {
                  ...
                  !!decodedToken && signedIn ? (
                    ...
                    <div className="wrapper__form">
                      <div className="header__page">
                        <h1 className="header__heading header__heading--main abb">
                          ABB Industrigymnasium
                        </h1>

                        <h2 className="header__heading header__heading--sub--alt">
                          Logga in med mailadress
                        </h2>
                      </div>
                      <SignInForm onSignIn={this.onSignIn} />
                      <Link id="mitt" to="/lookbook"  >
                     <button className="button button__form--submit">Se Bokningar<img className="back" src="https://cdn4.iconfinder.com/data/icons/time-date-management/512/calendar_milestones-512.png" ></img> </button></Link>
